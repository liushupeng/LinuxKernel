...
在学习 Kernel 网上冲浪查阅相关资料时，会发现很多大佬的博客。除了与你检索词相关页面内容外，翻看他们的主页也是一个很好的扩展知识宽度的途径。下面罗列他们的主页地址，希望同样可以对你有所帮助。

-   [Intelligent Computing Architecture](http://ilinuxkernel.com/) 
